...
This module implements a custom diffusion policy designed for long-horizon tasks.

For the transformer-based implementation, please see the separate `long_task_transformer` module.
