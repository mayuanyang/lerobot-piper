...
from .smolvlm_encoder import (  # noqa: F401  (re-exported for callers)
    LoRALinear, apply_lora_to_vision_layers, apply_lora_to_text_layers,
    create_sinusoidal_pos_embedding, _build_rope_cache, _rotate_half,
    _apply_rope, _modulate, _hard_negative_perm, SmolVLMEncoderMixin,
)
...
class WilroTransformer(SmolVLMEncoderMixin, nn.Module):
    ...
    def __init__(self, config: WilroConfig):
        ...
        self.init_encoder_state()           # see SmolVLMEncoderMixin
